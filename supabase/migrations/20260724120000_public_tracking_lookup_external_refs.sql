-- Make branded public order tracking robust for customers.
--
-- Long-lived customer URL:
--   /{businessSlug}/order-tracking/{orderRef}?email={customerEmail}
--
-- This function intentionally remains email-gated and optionally slug-gated,
-- but accepts all Fyll/WooCommerce/Fyll Checkout/import identifiers that can
-- reasonably represent the same customer order.
